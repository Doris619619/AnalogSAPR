// 验证几何变换、增强 B*-tree、论文 placement 框架和 routing adapter 的核心行为。
...
void run_router_tests() {
    ...
    const auto tree = sapr::make_enhanced_tree(circuit);
    ...
    sapr::SpaceNode space{"space", "M1", sapr::SpaceNodeKind::Right, {{"p", "space", {{"N", 1.0, 4.0, std::nullopt}, {"N", 1.0, 4.0, std::nullopt}}}}};
